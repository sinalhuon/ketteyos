...
INSERT INTO "new_Event" ("brideFatherName", "brideFirstName", "brideLastName", "brideMotherName", "createdAt", "date", "description", "endDate", "eventDays", "eventTime", "groomFatherName", "groomFirstName", "groomLastName", "groomMotherName", "id", "invitationMessage", "location", "logoUrl", "mapUrl", "musicUrl", "schedule", "startDate", "templateId", "title", "updatedAt", "userId", "venueDetails") SELECT "brideFatherName", "brideFirstName", "brideLastName", "brideMotherName", "createdAt", "date", "description", "endDate", "eventDays", "eventTime", "groomFatherName", "groomFirstName", "groomLastName", "groomMotherName", "id", "invitationMessage", "location", "logoUrl", "mapUrl", "musicUrl", "schedule", "startDate", "templateId", "title", "updatedAt", "userId", "venueDetails" FROM "Event";
DROP TABLE "Event";
