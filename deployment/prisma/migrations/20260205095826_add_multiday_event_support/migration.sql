...
INSERT INTO "new_Event" ("brideFatherName", "brideFirstName", "brideLastName", "brideMotherName", "createdAt", "date", "description", "eventTime", "groomFatherName", "groomFirstName", "groomLastName", "groomMotherName", "id", "invitationMessage", "location", "logoUrl", "mapUrl", "musicUrl", "schedule", "templateId", "title", "updatedAt", "userId", "venueDetails") SELECT "brideFatherName", "brideFirstName", "brideLastName", "brideMotherName", "createdAt", "date", "description", "eventTime", "groomFatherName", "groomFirstName", "groomLastName", "groomMotherName", "id", "invitationMessage", "location", "logoUrl", "mapUrl", "musicUrl", "schedule", "templateId", "title", "updatedAt", "userId", "venueDetails" FROM "Event";
DROP TABLE "Event";
